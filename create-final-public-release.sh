...
DESCRIPTION="BOSH release add-on for prometheus-boshrelease to add custom alertmanager notify clack template"
GITHUB_REPO="dohq/alertmanager-slack-template-boshrelease"

##
MAIN_MANIFEST="manifests/prometheus-alertmanager-template.yml"
